...
class RecordingEditor extends StatefulWidget {
  ...
  /// Destroys the capture — index row, source file and poster. Lives here
  /// rather than on the card on purpose: the row's action strip is play, edit
  /// and done, all of them cheap and reversible, and an irreversible control
  /// sitting a few pixels from `play` is the one mis-tap this app cannot undo.
