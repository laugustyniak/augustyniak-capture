...
import 'package:augustyniak_capture/features/recordings/data/media_importer.dart';
...
void main() {
  ...
  setUp(() {
    appDir = Directory.systemTemp.createTempSync('augustyniak-capture_app_');
    pickDir = Directory.systemTemp.createTempSync('augustyniak-capture_pick_');
